...
| **Feature flags / metadata** | `metadata={...}` | `{"agent_enabled": ..., "llm_provider": ...}` | Structured, queryable facts about *how* this specific request was handled — the boolean flags and config that changed its behavior |
